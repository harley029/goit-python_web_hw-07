...
Revision ID: 8d620e40e4f9
Revises: 
Create Date: 2024-05-02 23:22:46.907933
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['subjects_id'], ['subjects.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
